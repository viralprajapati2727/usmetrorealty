...
class JWElementTemplate extends JWElement
{
	...
	public function fetchElement($name, $value, &$node, $control_name)
	{
		...
		$plgTemplatesPath = version_compare(JVERSION, '1.6', 'ge') ? JPATH_SITE.'/plugins/system/allvideos_system/allvideos_system/tmpl' : JPATH_SITE.'/plugins/system/allvideos_system/tmpl';
		...
		$templatePath = JPATH_SITE.'/templates/'.$template.'/html/allvideos_system';
