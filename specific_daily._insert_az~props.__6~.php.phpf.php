<?php
    ...
    //$query = "(LIST_15=|RNKKL0G8XM0,RNKKL0G8Y02)";
...
echo "AZ Properties starting at:"; echo $date2;
                           ...
                           if(!empty($row['my_prop_id'])) {
                            ...
                            if ($record['LIST_15'] != 'Active') {
                               ...
                               if($update_status_exe){
                                  echo "This ".$record['LIST_105']." MLS Number Property is Not Active. So Deleted this Property from our Database - AZ";
                                  }

                               echo " AZ A Deleting Images ";
                               $update_status = "DELETE FROM ".$prefix."iproperty_images WHERE propid=".$my_prop_id;
                               $update_status_exe = mysqli_query($conn, $update_status);
                               if($update_status_exe){
                                 echo "This my_prop_id=".$my_prop_id." Images Deleted from images Database - AZ";
                               }
                                ...
                                if($keys[$i] == "LIST_39") {
                                    ...
                                    if(!empty($record[$keys[$i]])) {
                                        ...
                                        if (mysqli_num_rows($result) <= 0) {
                                          ...
                                          $_iproperty_citiesmid['values'][] = "('".$record[$keys[$i]]."','',3962)";

                                          echo "INSERTING CITY: ";echo $record[$keys[$i]];
                        ...
                        if (mysqli_num_rows($result) > 0) {
                           ...
                           if(!empty($row['my_prop_id'])) {
                            ...
                            if ($record['LIST_15'] != 'Active') {
                               ...
                               echo " AZ B Deleting Images ";
                               $update_status = "DELETE FROM ".$prefix."iproperty_images WHERE propid=".$my_prop_id;
                               $update_status_exe = mysqli_query($conn, $update_status);
                               if($update_status_exe){
                                 echo "This my_prop_id=".$my_prop_id." Images Deleted from our Database - AZ";
                               }
                        ...
                        if (mysqli_num_rows($result) > 0) {
                           ...
                           if(!empty($row['my_prop_id'])) {
                            ...
                            if ($record['LIST_15'] != 'Active') {
                               ...
                               echo " AZ C Deleting Images ";
                               $update_status = "DELETE FROM ".$prefix."iproperty_images WHERE propid=".$my_prop_id;
                               $update_status_exe = mysqli_query($conn, $update_status);
                               if($update_status_exe){
                                 echo "This my_prop_id=".$my_prop_id." Image Deleted from our Database - AZ";
                               }
