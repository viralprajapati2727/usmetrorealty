...
class EDocmanModelManageCategories extends OSModelList
{
	/**
	...
	public function __construct($config = array())
	{
        ...
        $this->state->insert('filter_level', 'int', $app->getUserStateFromRequest($context . 'filter_level', 'filter_level', 0, 'int'));
        $this->state->insert('filter_full_ordering', 'word');
	}
