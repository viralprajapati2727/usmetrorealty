...
<input type="hidden" name="page" id="page" value="<?php echo $currPage; ?>" />
	...
	<?php if(fetchParam('show_single_name_field') == 'true') { ?>
		<tr>
		<td class="RSWS_form_first_col">
			<span id="fname_d" class="RSWS_form_text"><?php echo JText::_('Agents'); ?>:</span><span class="RSWS_form_star_color">*</span>
		</td>
		<td>
