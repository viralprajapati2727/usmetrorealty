(function() {
    ...
    Morris.Line = (function(_super) {
        ...
        Line.prototype.drawLinePath = function(path, lineColor) {
            return this.raphael.path(path).attr('stroke', '#2c3e50').attr('stroke-width', this.options.lineWidth);
        };

        Line.prototype.drawLinePoint = function(xPos, yPos, size, pointColor, lineIndex) {
            return this.raphael.circle(xPos, yPos, size).attr('fill', '#2c3e50').attr('stroke-width', this.strokeWidthForSeries(lineIndex)).attr('stroke', this.strokeForSeries(lineIndex));
        };
    ...
    Morris.Area = (function(_super) {
        ...
        Area.prototype.drawFilledPath = function(path, fill) {
            return this.raphael.path(path).attr('fill', '#2980b9').attr('fill-opacity', this.options.fillOpacity).attr('stroke-width', 0);
        };
