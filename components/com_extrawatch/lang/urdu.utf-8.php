...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "غلط : لائسنس کی اورآپکی ڈومین میچ نہیں کرتے۔ کیا آپ نےیہی ڈومین کا نام ڈونیشن فارم میں لکھا تھا جو آپ نیچے دیکھ رہے ہیں؟ درست کی کے لیے درخواست کریں یا رابطہ کریں : live chat on extrawatch.com or submit support ticket via <a href='http://www.extrawatch.com/ticket' target='_blank'>http://www.extrawatch.com/ticket</a><br/>");
