...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "<b>Error: la clave de licencia y su dominio no concuerdan.</b><br/>¿Ha ingresado el nombre de dominio en el formulario de activación tal como se muestra abajo? Por favor contacte: live chat on extrawatch.com or submit support ticket via <a href='http://www.extrawatch.com/ticket' target='_blank'>http://www.extrawatch.com/ticket</a>");
