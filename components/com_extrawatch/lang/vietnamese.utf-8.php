...
DEFINE('_EW_CONFIG_LICENCE_DONT_MATCH', "<b> Lỗi: các phím giấy phép và tên miền của bạn không phù hợp </b> <br/> Bạn nhập vào tên miền tương tự vào hình thức đóng góp là một trong những bạn xem dưới đây. <br/> Nhấp vào 'yêu cầu <b> đúng mã khóa kích hoạt </b>' dưới đây, hoặc liên hệ: live chat on extrawatch.com or submit support ticket via <a href='http://www.extrawatch.com/ticket' target='_blank'>http://www.extrawatch.com/ticket</a> <br/>");
