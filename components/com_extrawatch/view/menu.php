...
<a href='https://www.extrawatch.com/buy?utm_campaign=&utm_source=&utm_medium=web&utm_content=ew_application_menu';' target='_blank' title='<?php echo _EW_DOWNLOAD_PRO;?>'><?php echo _EW_DOWNLOAD_PRO;?></a> <img
    src='<?php echo($extraWatch->config->getLiveSiteWithSuffix());?>components/com_extrawatch/img/icons/external.gif'  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
    border='0'/></a>  	 	    	    		  	 	  	 	  		 	 		    	 			 	   		  	 	 		 	 	   	      	  	 		 		 				 			 		  		    	 		 		  
