...
/**
 * Okey DOC Component Route Helper
 *
 * @static
 * @package     Joomla.Site
...
abstract class OkeydocHelperRoute
{
  ...
  {
    $needles = array('document' => array((int) $id));
  ...
  public static function getFormRoute($id, $return = null)
  {
    // Create the link.
    if($id) {
      $link = 'index.php?option=com_okeydoc&task=document.edit&d_id='.$id;
    }
    else {
      $link = 'index.php?option=com_okeydoc&task=document.add&d_id=0';
    }
