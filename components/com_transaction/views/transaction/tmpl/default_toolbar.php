...
jQuery(document).ready(function(){
    ...
    jQuery('.navbar-inner li a').click(function(){
        //alert('You will lose all data that you entered until you send them by clicking SEND button !!');
        if (confirm("You will lose all data that you entered until you send them by clicking SEND button !!")) {
            return true;
        } else {
            return false;
        }
...
<script type="text/javascript">
  // alert if change data mahesh
jQuery(document).ready(function(){
var unchanged_form="";
var changed_form ="";
function alertFunc() {   
    unchanged_form = jQuery("#adminForm").serialize();
}
setTimeout(alertFunc,3000);
 
    jQuery('.navbar-inner li a').click(function(){
        //alert('You will lose all data that you entered until you send them by clicking SEND button !!');
         changed_form = jQuery("#adminForm").serialize();
        if(JSON.stringify(changed_form) != JSON.stringify(unchanged_form)){
            if (confirm("You will lose all data that you entered until you send them by clicking SEND button !!")) {
                return true;
            } else {
                return false;
        ...
        <ul class="nav">
            ...
            <div class="dropdown-content">
             ...
             <?php if($agent_type==1){ ?><li<?php if($layout == 'myproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=myproplist'); ?>">My Listings</a></li><?php } ?>
                ...
                <?php if($agent_type==1){ ?><li <?php if($view1 == 'transactionlist' || $view1 == 'transaction') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_transaction&view=transactionlist'); ?>">Transaction</a></li><?php } ?>
                </li>
             <?php if($agent_type==3){ ?><li<?php if($layout == 'mysellerproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=mysellerproplist'); ?>">My Listings</a></li><?php } ?>
                ...
                <?php if($agent_type==2){ ?><li<?php if($layout == 'mybuyerproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=mybuyerproplist'); ?>">My Listings</a></li><?php } ?>
