    ...
    <br>
        ...
        if (el.id){
            if(searchOptions.agent_type == 1){
                ...
                var imgpopover = jQuery('<a href="#saveModal" class="btn btn-small hasTooltip btn-fade" data-toggle="modal" role="button"><span id="ip_previewimg1'+index+'" class="icon-save fa fa-save"></span></a><input type="hidden" name="id" value='+el.id+'>');
                jQuery(imgpopover).attr('data-content', img);
                 btnGroup.append(imgpopover);
