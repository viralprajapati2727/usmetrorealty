...
var ipMapFunctions = (function(app) {
    ...
    **************/
    ...
    app.addMarker = function(listing){
        ...
        //
        /*console.log(ipMapFunctions.ipMarkers);
        var locations = ipMapFunctions.ipMarkers;
        var locations_num = jQuery(ipMapFunctions.ipMarkers).size();
        console.log(locations_num);
        jQuery.each(locations, function(i, el){
