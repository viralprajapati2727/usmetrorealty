...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            ...
            <li><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=agentform&layout=edit&id='.$this->agent->id.'&'.JSession::getFormToken().'=1&Itemid=0&return='.$this->return, false); ?>"><?php echo JText::_('COM_IPROPERTY_PROFILE'); ?></a></li>
