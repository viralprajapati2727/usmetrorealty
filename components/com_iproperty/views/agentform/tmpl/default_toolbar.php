        ...
        <ul class="nav">
           ...
           <?php } else if($agent_type==3){ ?>
            ...
            <!-- <li<?php if(($layout == 'proplist' || $layout == 'sellerproplist' || $layout == 'buyerproplist' || $view == 'allproperties') && $view != "ipuser") echo ' class="active"'; ?>>
             ...
             <?php if($agent_type==3){ ?><li<?php if($layout == 'mysellerproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=mysellerproplist&Itemid=323'); ?>">My Listings</a></li><?php } ?>
            ...
            <li <?php if($view == 'agentform' && $layout == 'edit') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=agentform&layout=edit&id='.$agent_id.'&'.JSession::getFormToken().'=1&return='.$this->return, false); ?>"><?php echo JText::_('COM_IPROPERTY_PROFILE'); ?></a></li>
