...
{    
    ...
    { //customize start(viral)
      if(JRequest::getVar('layout','') == 'searchcriterialist'){
          ...
          $model = new IpropertyModelSearchcriteriaForm;
          $this->model = $model;
          $this->data= $model->getsearchData();
      ...
      //customize end
        ...
        if($layout != 'dashboard' && $layout != 'sellerproplist' && $layout != 'buyerproplist' && $layout != 'searchcriterialist' && $layout != 'myproplist' && $layout != 'mysellerproplist' && $layout != 'mybuyerproplist' && $layout != 'downloads')
        {
           ...
           // echo "<pre>"; print_r($this->items); exit;
            ...
            $this->state        = $model->getState();
            $this->setLayout(JRequest::getWord('layout', '  ')); // customize end
        }elseif($layout == 'mybuyerproplist'){
            $model = $this->getModel('propList');
            $this->items        = $model->getIpProperties();
            $this->pagination   = $model->getPagination();
            $this->state        = $model->getState();
            $this->setLayout(JRequest::getWord('layout', '  ')); // customize end
            ...
            $this->setLayout(JRequest::getWord('layout', 'downloads'));
        }
