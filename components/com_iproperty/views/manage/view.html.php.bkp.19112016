...
{    
    ...
    { //customize start(viral)
      ...
      //customize end
        ...
        if($layout != 'dashboard' && $layout != 'sellerproplist' && $layout != 'buyerproplist' && $layout != 'searchcriterialist' && $layout != 'myproplist' && $layout != 'mysellerproplist' && $layout != 'mybuyerproplist')
        {
