            ...
            <tbody>
                ...
                if( $this->items ):                           
                    ...
                    foreach($this->items as $i => $item){
                        ...
                        if($item->approved)
                        {
                            $view_link = JRoute::_('index.php?option=com_iproperty&view=property&id='.$item->id.'&Itemid=322');
                            //$linktitle = '<a title="" rel="tooltip" class="btn btn-micro hasTooltip " href="'.$view_link.'" data-original-title="View">'.$linktitle.'</a>';
                        }
                        // end [[CUSTOM]] RI
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="has-context">
                                <div class="pull-left">
                                   ...
                                   <?php 
                                    ...
                                    <?php else : ?>
                                        <?php echo '<a title="" href="'.$view_link.'">'.$this->escape($linktitle).'</a>'; ?>                                    
                                    <?php endif; 
                                        } else { //customize  end
                                            echo '<a title="" href="'.$view_link.'">'.$this->escape($linktitle).'</a>'; 
                                        }
                                    ?>
                            ...
                            <td class="small hidden-phone">
                                ...
                                if($cats){
                                    foreach( $cats as $c ){
                                        echo ipropertyHTML::getCatName($c);
