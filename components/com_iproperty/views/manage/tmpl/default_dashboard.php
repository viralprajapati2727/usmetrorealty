...
echo '<h3 class="dashboard-title">Dashboard</h3>';

//echo "<pre>";print_r($this->agent->agent_type); exit;
?>
<div class="span<?php echo $agent_span; ?> ip-agent-overview-desc">
            ...
            <a style="text-transform:capitalize;" href="<?php echo $agentlink; ?>"><b><span itemprop="name"><?php echo ipropertyHTML::getAgentName($this->agent->id); ?></span></b></a>
            ...
            <?php endif; ?>
            <?php if($this->agent->agent_type): 
                if($this->agent->agent_type==1){ ?>
                    <em>(Agent)</em>
               <?php } else if($this->agent->agent_type==2){ ?>
                          <em>(Buyer)</em>
                <?php } else if($this->agent->agent_type==3){ ?> 
                    <em>(Seller)</em>
               <?php  }
           endif; ?>
            ...
            <span class="ip-agent-title"><?php echo $this->agent->title; ?></span>
            <?php endif; ?>
                <?php                        
            ...
            <div class="row-fluid">
                <div class="span12">
                <div class="span12 pull-right"><strong><h5>Account Details</h5></strong></div>                  
                    <div class="span4 ip-agent-details">                
                        <ul class="agent-list-details small">
                            ...
                            if($this->agent->alicense && $this->settings->agent_show_license) echo '<li class="ip-license"><b><abbr title="'.JText::_('COM_IPROPERTY_LICENSE' ).'">License:</abbr></b> '.$this->agent->alicense . '</li>';
                            ?>
                        </ul>
                    </div>
            ...
            <div class="row-fluid custom-total-items-for-buyer">
                <div class="span12"> 
                    <div class="span12 ip-agent-details">
                        <ul class="agent-list-details small">
                            <?php
                            if($this->agent->agent_type==2){
                                
                                $searchCriNum = ipropertyHTML::getBuyerSearchCriteriaNum($this->agent->id);
                                echo '<div class="dash-item1"><li><strong><h5>Search Criteria</h5></strong></li>';
                                if($searchCriNum){
                                ...
                                echo '<div class="dash-item2"><li><strong><h5>Properties</h5></strong></li>';
                                if($savedPropsNum){
                                ...
                                echo '<div class="dash-item3"><li><strong><h5>Help Desk</h5></strong></li>';
                                if($savedHelpsNum){
                            ...
                            if(($this->agent->agent_type) == 3){
                                ...
                                echo '<div class="dash-item3"><strong><h5>Properties</h5></strong>';
                                if($myListingNum){
