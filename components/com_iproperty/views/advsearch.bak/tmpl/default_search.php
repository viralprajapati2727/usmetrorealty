...
$document->addScriptDeclaration($jcomboscript22);
...
<div id="ip-searchfilter-wrapper" class="well hidden-phone">
    <div id="ip-mainfilter-container">        
        <form action="<?php echo JRoute::_('index.php?option=com_iproperty&view='.$jinput->getCmd('view').'&id='.$jinput->getInt('id')); ?>" method="post" name="ip_quick_search" class="ip-quicksearch-form form-inline adv-search" id="ip-quicksearch-form" novalidate="novalidate">
            <div class="ip-quicksearch-optholder">
                <!-- Basic filters -->
                <div class="control-group">
                    <?php if ( $this->params->get('qs_show_keyword', $this->settings->qs_show_keyword) ): ?>
                        <input type="text" class="input-medium ip-qssearch custom-width" placeholder="Property MLS #, Address, City & State or Zip" name="filter_keyword" id="filter_keyword" value="<?php echo $this->state->get('filter.keyword'); ?>" />
                    <?php endif; ?>
                </div>
            ...
            <div class="adv-link_wrapper">
                <a href="index.php?option=com_iproperty&amp;view=advsearch&amp;Itemid=323" class="adv-link">Advanced Search</a>
            </div>
