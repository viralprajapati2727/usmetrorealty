...
class IpropertyViewAllProperties extends JViewLegacy
{
    ...
    protected function _prepareDocument() 
    {
        ...
        //Kalim removed this title: $title = (is_object($menu) && $menu->query['view'] == 'allproperties') ? $menu->title : JText::_('COM_IPROPERTY_ALL_PROPERTIES');
