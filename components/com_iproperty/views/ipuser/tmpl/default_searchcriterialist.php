...
<div class="ip-manage-list<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=SearchCriteria" method="post" name="adminForm" id="adminForm">
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="small hidden-phone">
                                <?php
                                 ...
                                 $cities_names = $model->getCitiesNameFromId($item->city); ?>
