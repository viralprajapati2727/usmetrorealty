...
class IpropertyViewIPuser extends JViewLegacy
{
    ...
    public function display($tpl = null)
    {
        ...
        if(JRequest::getVar('view','') == 'ipuser'){
          require_once JPATH_COMPONENT.'/models/searchcriteriaform.php';
          require_once JPATH_COMPONENT.'/models/proplist.php';
          $model = new IpropertyModelSearchcriteriaForm;
          $modellist = new IpropertyModelPropList;
          $this->data= $model->getsearchData();
          $this->pagination   = $modellist->getPagination();
          //echo "<pre>"; print_r($this->pagination); exit;
          $this->state        = $modellist->getState();
