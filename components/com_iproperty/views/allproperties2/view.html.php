...
class IpropertyViewAllProperties2 extends JViewLegacy
{
    protected $params;
    protected $items;
    protected $featured;
    ...
    public function display($tpl = null)
	{
      ...
      //echo "sdafs<pre>"; print_r($this->items); exit;
        ...
        $model=$this->getModel('AllProperties');
        //echo "<pre>"; print_r($_REQUEST); exit;
        $this->results = $model->focusState();
        //echo $this->results;exit;
    ...
    protected function _prepareDocument() 
    {
        ...
        $title = (is_object($menu) && $menu->query['view'] == 'allproperties2') ? $menu->title : JText::_('COM_IPROPERTY_ALL_PROPERTIES');
        $browser_title = (is_object($menu) && $menu->query['view'] == 'allproperties2') ? $this->params->get('page_title') : $title;
		...
		// Breadcrumbs
        if(is_object($menu) && $menu->query['view'] != 'allproperties2') {
