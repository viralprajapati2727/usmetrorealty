...
<div class="navbar">
    <div class="navbar-inner">
        ...
        <ul class="nav">
            <!-- customize start(viral)-->
            <li <?php if($layout == 'dashboard') echo ' class="active"'; ?>><a class="brand" href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=dashboard&Itemid=0'); ?>"><?php echo JText::_('COM_IPROPERTY_DASHBOARD'); ?></a></li>
            <?php if($agent_type==2){ ?>
            <?php
            ...
            ?>
            <li class="dropdown" <?php if($view == 'ipuser') echo ' class="active"'; ?>> <a href="#">Favourites/Searches</a>
            ...
            <?php } else if($agent_type==3){ ?>
                     <li class="dropdown" <?php if($view == 'ipuser') echo ' class="active"'; ?>> <a href="#">Save Searches</a>
            <div class="dropdown-content">
                <a href="index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=searchcriteria"><?php echo JText::_('SEARCH_CRITERIA')?></a>
                <a href="index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=savedfavorites"><?php echo JText::_('COM_IPROPERTY_MY_SAVED_PROPERTIES')?></a>
                <a href="index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=savedsearches"><?php echo JText::_('COM_IPROPERTY_MY_SAVED_SEARCHES')?></a>
            ...
            <!-- <li<?php if(($layout == 'proplist' || $layout == 'sellerproplist' || $layout == 'buyerproplist' || $view == 'allproperties') && $view != "ipuser") echo ' class="active"'; ?>>
             ...
             <?php if($agent_type==3){ ?><li<?php if($layout == 'mysellerproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=manage&layout=mysellerproplist'); ?>">My Listings</a></li><?php } ?>
                 <?php if($agent_type==3){ ?><li<?php if($view1 == 'help') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=help&layout=agenthelp'); ?>">Help Desk</a></li><?php } ?>
                <!-- <?php if($agent_type==2){ ?><li<?php if($layout == 'mybuyerproplist') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=ipuser&Itemid=319'); ?>">My Listings</a></li><?php } ?> -->
                <?php if($agent_type==2){ ?><li<?php if($view1 == 'help') echo ' class="active"'; ?>><a href="<?php echo JRoute::_('index.php?option=com_iproperty&view=help&layout=agenthelp'); ?>">Help Desk</a></li><?php } ?>
