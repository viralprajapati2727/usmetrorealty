...
<article class="item-page<?php echo $this->pageclass_sfx?>">
    ...
    <div class="row-fluid">
        <div class="span12 ip-prop-bottom">
            <div class="span12">
            <h4><?php echo JText::_('COM_IPROPERTY_DESCRIPTION');?></h4>
            ...
            <div class="span12">
            <h4><?php echo JText::_('COM_IPROPERTY_REQUEST_SHOWING');?></h4>
            <?php  echo $this->loadTemplate('requestshow');?>
            </div>
            <!-- <div class="span12">
            <h4><?php //echo JText::_('COM_IPROPERTY_SUBMIT_SEND');?></h4>
            <?php //echo $this->loadTemplate('sendtofriend');?>
            </div> -->
            <?php 
            // details pane
