...
$details_array = array( "mls_id"  => JText::_('COM_IPROPERTY_MLS' ),
                "beds"  => JText::_('COM_IPROPERTY_BEDS' ),
                 "baths"        => JText::_('COM_IPROPERTY_BATHS' ),
                 "reception"    => JText::_('COM_IPROPERTY_RECEPTION' ),
                 ...
                 "state"  => JText::_('COM_IPROPERTY_PROPERTY_STATE' ),
...
foreach ($details_array as $key=>$value)
{
    if ($this->p->$key AND $this->p->$key != '0.0')
    {
        ...
        if($this->p->state == '1'){
            $this->p->state = 'Active';
        }else if($this->p->state == '0'){
            $this->p->state = 'Not Active';
        }
        echo '
