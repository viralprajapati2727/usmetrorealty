...
<div class="ip-agentlist<?php echo $this->pageclass_sfx;?>">
    ...
    //custom viral load quick search tmpl
    ...
    {
        echo
          //custom viral this h2 tag put in below span tag
         //<h2 class="ip-agent-header">'.JText::_('COM_IPROPERTY_AGENTS').'</h2>
            '<span class="pull-right small ip-pagination-results">'.$this->pagination->getResultsCounter().'</span><div class="clearfix"></div>';
            $this->k = 0;
