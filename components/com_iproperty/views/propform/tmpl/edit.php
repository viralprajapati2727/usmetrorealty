...
if($this->settings->map_provider)
{
    ...
    if (!defined('IPGMAP')){
		$mapsurl = $params->get('maptype', 0) ? '//ecn.dev.virtualearth.net/mapcontrol/mapcontrol.ashx?v=7.0&mkt='.$curr_lang->get('tag') : '//maps.googleapis.com/maps/api/js?key=AIzaSyCTiebqArYO5wRZ1JRO5eePHsf-Yc94fuM&sensor=false';
