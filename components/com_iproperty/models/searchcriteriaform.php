...
*/
		...
		$allDone->redirect('index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=searchcriteria');
	...
	public function deleteCriterias($cid){
		...
		$app = JFactory::getApplication();
		$app->redirect('index.php?option=com_iproperty&view=ipuser&Itemid=319&tab=searchcriteria');
