...
{    
    ...
    protected function getWhere()
    {
        ...
        $where['searchfields']  = array('street_num','street','street2','city','county','locstate','subdivision','postcode','short_description','description','mls_id','cn.title','ct.title','st.title');
