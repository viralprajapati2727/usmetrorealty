...
class IpropertyControllerPropForm extends JControllerForm
{
	...
	{
		if(!isset($validData['general_amens']))
			$validData['general_amens'] = array('0');
	...
	public function save($key = null, $urlVar = 'id')
	{
		...
		if ($result && $task != 'apply') {
			$message = JText::sprintf('COM_IPROPERTY_PROPERTY_HAS_BEEN_SAVED');
    ...
    public function checkin()
    {
        ...
        $ids = array($this->input->getInt('id'));
