...
<article class="page-item page-item__gallery page-item__<?php echo $this->pageclass_sfx?>">
	...
	<div class="page-gallery_img">
		<figure class="item_img img-full img-full__<?php echo htmlspecialchars($imgfloat); ?>">
			<a class="fancybox-thumb zoom articleGalleryZoom" data-fancybox-group="portfolio" data-fancybox-type="image" data-fancybox="fancybox" href="<?php echo JURI::base().htmlspecialchars($images->image_fulltext); ?>">
