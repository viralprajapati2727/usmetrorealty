...
<?php endif;
  ...
  <figure class="item_img img-intro img-intro__<?php echo htmlspecialchars($imgfloat); ?>">
    ...
    <a class="zoom galleryZoomIcon fancybox-thumb" data-fancybox-type="image" data-thumbnail="<?php echo JURI::base().htmlspecialchars($images->image_intro); ?>" data-fancybox-group="gallery" data-fancybox="fancybox" href="<?php echo JURI::base().htmlspecialchars($images->image_fulltext); ?>">
