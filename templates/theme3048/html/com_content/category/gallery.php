...
<section class="page-gallery page-gallery__<?php echo $this->pageclass_sfx;?>">
  ...
  <div class="filters">
    ...
    <ul id="filters" class="btn-group">
      ...
      <li><a class="filter btn btn-info" data-filter="<?php echo special_chars_replace(str_replace(" ","",$value)); ?>"><?php echo $value; ?></a></li>
      <?php endforeach; ?>
    </ul>
  </div>
  <?php endif;
  ...
  <ul id="isotopeContainer" class="gallery items-row cols-<?php echo (int) $this->columns;?> <?php echo $hover_active; ?>">
    ...
    $this->item = &$item; ?>
    <li class="gallery-item mix mix_all gallery-grid <?php echo $item_hover_style; ?> <?php echo special_chars_replace(str_replace(" ","",$item->category_title)); ?>" data-date="<?php echo JHtml::_('date', $this->item->publish_up, 'YmdHis'); ?>" data-name="<?php echo $this->item->title; ?>" data-popularity="<?php echo $this->item->hits; ?>">
      <?php
      $this->item = &$item;
      echo $this->loadTemplate('item');
      $counter++; ?>
