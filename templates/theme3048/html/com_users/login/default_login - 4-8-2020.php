...
<div class="page-login page-login log">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal">
		...
		<div class="controls" style="margin-top:10px;"><span class="linklog">Don't have an account?<a href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>">Sign Up<?php //echo JText::_('COM_USERS_LOGIN_REGISTER'); ?></a></span></div>
		<?php endif; ?>
		</div>
