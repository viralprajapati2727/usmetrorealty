...
class IpropertyViewDownload extends JViewLegacy
{
    protected $form;
	protected $item;
	protected $state;
    ...
    protected function addToolbar()
	{
		...
		JToolBarHelper::title($isNew ? JText::_('COM_IPROPERTY_ADD_DOWNLOADS') : JText::_('COM_IPROPERTY_ADD_DOWNLOADS').': '.$this->item->name, 'iproperty.png');
