...
<script type="text/javascript">
    Joomla.orderTable = function() {
		...
		Joomla.tableOrdering(order, dirn, order1, '');
	}
</script>
...
<?php endif;?>
        ...
        <div id="filter-bar" class="btn-toolbar">
            ...
            <select onchange="this.form.submit();" name="filter[agent_type]" id="filter_agent_type">
                <option value="">User Type</option>
                <option <?php if($this->state->get('filter.agent_type') == 1) { echo 'selected="selected"'; } ?> value="1">Agent</option>
                <option <?php if($this->state->get('filter.agent_type') == 2) { echo 'selected="selected"'; } ?> value="2">Buyer</option>
                <option <?php if($this->state->get('filter.agent_type') == 3) { echo 'selected="selected"'; } ?> value="3">Seller</option>
            </select>
            ...
            <thead>
                <tr>
                    ...
                    <th width="10%" class="nowrap hidden-phone">
                        <?php echo JHTML::_('grid.sort',  'COM_IPROPERTY_USER_TYPE', 'user_name', $listDirn, $listOrder ); ?>
                    </th>
                ...
                if(count($this->items) > 0):
                    foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->company; ?>">
                            ...
                            <td class="small hidden-phone"><?php $item_agent_type = $item->agent_type; if($item_agent_type == "1"){ echo 'Agent'; } elseif($item_agent_type == "2") { echo 'Buyer'; } elseif($item_agent_type == "3") { echo 'Seller'; } ?></td>
