        ...
        <div class="span9 form-horizontal">
            ...
            ?>
                <div class="row-fluid form-horizontal">
                    ...
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo $this->form->getLabel('blog_num'); ?>
                        </div>
                        <div class="controls">
                            <?php echo $this->form->getInput('blog_num'); ?>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="control-label">
            ...
            ?>
                <div class="row-fluid">
                    <div class="span6 pull-left form-vertical">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('technology'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('technology'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('listing_member_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('listing_member_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('listing_office_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('listing_office_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('stories'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('stories'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('current_use'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('assessor_number'); ?>
                            </div>
                        </div>                       
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('assessor_number'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('assessor_number'); ?>
                            </div>
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('marketing_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('marketing_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('builder_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('builder_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('planned_comm_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('planned_comm_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('elementary_school'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('elementary_school'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('middle_school'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('middle_school'); ?>
                            </div>
                        </div>
                    </div>
                    <div class="span6 pull-right form-vertical">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('int_list_id'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('int_list_id'); ?>
                            </div>
                    </div>
                    <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('agentid'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('agentid'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('agent_phone_num'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('agent_phone_num'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('picture_count'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('picture_count'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('map_code'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('map_code'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('street_suffix'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('street_suffix'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('interior_levels'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('interior_levels'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('total_cover_space'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('total_cover_space'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('building_style'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('building_style'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('fireplace'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('fireplace'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('special_listing_cond'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('special_listing_cond'); ?>
                            </div>
                        </div>
                        
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('high_school'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('high_school'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('legal_township'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('legal_township'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('legal_range'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('legal_range'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('legal_section'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('legal_section'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('legal_lot_num'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('legal_lot_num'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('association_hoa_fee'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('association_hoa_fee'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                        ...
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('association_hoa_fee_name'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('association_hoa_fee_name'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('association_hoa2_fee'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('association_hoa2_fee'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
                                <?php echo $this->form->getLabel('custom_hoa2name_key'); ?>
                            </div>
                            <div class="controls">
                                <?php echo $this->form->getInput('custom_hoa2name_key'); ?>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="control-label">
