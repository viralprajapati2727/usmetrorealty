...
ALTER IGNORE TABLE `#__iproperty_agents` ADD `published` `state` tinyint(3) NOT NULL DEFAULT '0';
...
ALTER IGNORE TABLE `#__iproperty_agents` CHANGE `published` `state` tinyint(3) NOT NULL DEFAULT '0';
...
ALTER IGNORE TABLE `#__iproperty_categories` ADD `published` `state` tinyint(3) NOT NULL DEFAULT '0';
ALTER IGNORE TABLE `#__iproperty_categories` ADD `language` char(7) NOT NULL AFTER `checked_out_time`;
ALTER IGNORE TABLE `#__iproperty_categories` CHANGE `published` `state` tinyint(3) NOT NULL DEFAULT '0';
