...
class IpropertyModelGallery extends JModelLegacy
{
    ...
    public function loadGallery($propid = false, $own = false, $limitstart = 0, $limit = 50, $type = 0, $fname = false, $mediatype = false)
    {
        $db     	= JFactory::getDbo();
    ...
    public function uploadIMG($file, $propid)
    {
        ...
        if (isset($file)) {
            ...
            $dest_dir               = $path.$cfg['imgpath'].$propid.'/'; // [[CUSTOM]] RI, for custom path
            ...
            if ((strcasecmp($ext, ".gif")) && (strcasecmp($ext, ".jpg")) && (strcasecmp($ext, ".jpeg")) && (strcasecmp($ext, ".png")) &&(strcasecmp($ext, ".doc")) && (strcasecmp($ext, ".xls")) && (strcasecmp($ext, ".ppt")) && (strcasecmp($ext, ".odt")) && (strcasecmp($ext, ".odp")) && (strcasecmp($ext, ".ods")) && (strcasecmp($ext, ".swf")) && (strcasecmp($ext, ".pdf")) && (strcasecmp($ext, ".mpg")) && (strcasecmp($ext, ".mov")) && (strcasecmp($ext, ".avi")) && (strcasecmp($ext, ".zip")) && (strcasecmp($ext, ".mp4")) && (strcasecmp($ext, ".doc")) && (strcasecmp($ext, ".dot")) && (strcasecmp($ext, ".wbk")) && (strcasecmp($ext, ".docx")) && (strcasecmp($ext, ".docm")) && (strcasecmp($ext, ".dotx")) && (strcasecmp($ext, ".dotm")) && (strcasecmp($ext, ".docb")) && (strcasecmp($ext, ".xls")) && (strcasecmp($ext, ".xlt")) && (strcasecmp($ext, ".xlm")) && (strcasecmp($ext, ".xlsx")) && (strcasecmp($ext, ".xlsm")) && (strcasecmp($ext, ".xltx")) && (strcasecmp($ext, ".xltm")) && (strcasecmp($ext, ".xlsb")) && (strcasecmp($ext, ".xla")) && (strcasecmp($ext, ".xlam")) && (strcasecmp($ext, ".xll")) && (strcasecmp($ext, ".xlw"))&& (strcasecmp($ext, ".ppt")) && (strcasecmp($ext, ".pot")) && (strcasecmp($ext, ".pps")) && (strcasecmp($ext, ".pptx")) && (strcasecmp($ext, ".pptm")) && (strcasecmp($ext, ".potx")) && (strcasecmp($ext, ".potm")) && (strcasecmp($ext, ".ppam")) && (strcasecmp($ext, ".ppsx")) && (strcasecmp($ext, ".ppsm")) && (strcasecmp($ext, ".sldx")) && (strcasecmp($ext, ".sldm"))) {
            ...
            if(!$result['message']) {
                ...
                $pic->fname			= $vfilename;
                $pic->type			= $ext;
                $pic->path			= trim($cfg['imgpath'].$propid.'/');  // [[CUSTOM]] RI, for custom path
