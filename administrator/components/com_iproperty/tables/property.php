    ...
    {       
		...
		{        
            foreach( $amens as $amen ){
                $query = 'INSERT INTO #__iproperty_propmid (prop_id, amen_id, cat_id) VALUES ('.(int)$propid.','.(int)$amen.', 1)'; // [[CUSTOM]] RI , FOR STORING STATIC CATEGORY ID TEMP
                $this->_db->setQuery($query);
