...
?><form id="acym_form" action="<?php echo acym_completeLink(acym_getVar('cmd', 'ctrl')); ?>" method="post" name="acyForm">
	<div id="acym_content" class="acym__language__modal popup_size">
		...
		<div class="cell grid-x acym__language__modal__existing acym__content">
			...
			<textarea readonly rows="18" name="content" id="translation" class="acym__language__modal__existing__translation acym__blue"><?php echo $data['file']->content; ?></textarea>
		</div>
		<div class="acym__content acym__language__modal__custom margin-top-2" id="customcontent">
			...
			<textarea rows="10" name="customcontent" class="acym__language__modal__body acym__blue"><?php echo $data['file']->customcontent; ?></textarea>
