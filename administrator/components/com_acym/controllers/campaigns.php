...
class CampaignsController extends acymController
{
    ...
    private function storeRedirectListing($fromListing = false)
    {
        ...
        if ((empty($currentTask) || !in_array($currentTask, $taskToStore)) && !empty($_SESSION[$variableName])) {
            ...
            if (empty($currentTask)) $currentTask = 'campaigns';
    ...
    public function campaigns()
    {
        ...
        $data = [
            ...
            'element_to_display' => strtolower(acym_translation('ACYM_CAMPAIGNS')),
        ];
    ...
    public function welcome()
    {
        ...
        $data = [
            'email_type' => 'welcome',
            'element_to_display' => strtolower(acym_translation('ACYM_WELCOME_EMAILS')),
        ];
    ...
    public function unsubscribe()
    {
        ...
        $data = [
            ...
            'element_to_display' => strtolower(acym_translation('ACYM_UNSUBSCRIBE_EMAILS')),
        ];
