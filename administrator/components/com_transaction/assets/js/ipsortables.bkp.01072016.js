...
var buildSelectedDocs, getSelectedImages, getSelectedVideos, getAvailableImages, saveImageOrder, saveImageTags, deleteImage, addAvailImage, doAjaxRequest, buildSelected, buildAvailable, ajaxParseResult, buildPagination, ipPage, ipNextPageSet, ipPrevPageSet; 
...
jQuery(function($) {
	$(document).ready(function(){
		...
		buildSelectedVideos = function(img, prepend)
        {
			...
			var html    = $('<div class="thumbnail" />');
            var contain = $('<div class="ipimage-container" />');
			//var imgtag  = '{youtube}heu37ej3qs{/youtube} {mp4}'+imgpath+'{/mp4}';
			var imgtag  = '';
			var buttons = $('<p />');
			var edit    = $('<span class="icon-pencil" style="cursor: pointer;" rel="tooltip" title="'+ipGalleryOptions.language.edit+'"></span>');
			var del     = $('<span class="icon-minus" style="cursor: pointer;" rel="tooltip" title="'+ipGalleryOptions.language.del+'"></span>');
