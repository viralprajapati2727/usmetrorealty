...
class JFormFieldGallery extends JFormField
{
	...
	protected function getInput()
	{
		...
		<script type="text/javascript">
			...
			var aws = <?php echo $use_aws; ?>;
			var client_path = (ipGalleryOptions.client == 'administrator') ? 'administrator/' : '';
			var upload_url = aws ? 'http://<?php echo $bucket; ?>.s3.amazonaws.com/' : ipGalleryOptions.ipbaseurl+client_path+'index.php?option=com_transaction&task=ajax.ajaxUpload&format=raw&transaction_id='+ipGalleryOptions.transaction_id+'&'+ipGalleryOptions.iptoken+'=1';
        ...
        <div class="ipgallerycontainer">
            <div class="span12 image-uploader">
                <h4><?php echo JText::_('COM_TRANSACTION_UPLOAD'); ?></h4>
                <hr />
                <div id="ipUploader">
                    <!-- ADD STANDARD UPLOADER HERE AS FALLBACK -->
                    <?php echo JText::_('COM_TRANSACTION_FLASH_DISABLED'); ?>
                </div>
                <div class="clearfix"></div>
                <div class="remote_container control-group">
                    <div class="control-label">
                        <label class="hasTip" title="<?php echo JText::_('COM_TRANSACTION_REMOTE'); ?>::<?php echo JText::_('COM_TRANSACTION_UPLOAD_REMOTE'); ?>"><?php echo JText::_('COM_TRANSACTION_REMOTE'); ?></label>
                    </div>
                    <div class="controls">
                        <input type="text" id="uploadRemote" class="inputbox" maxlength="150" value="" />
                        <div id="uploadRemoteGo" class="btn btn-info"><?php echo JText::_('COM_TRANSACTION_SAVE'); ?></div>
                    </div>
                </div>
            </div>
            <div class="clearfix"></div>
            ...
            <ul class="nav nav-tabs">
                ...
                <li><a href="#ip_sortabledocs" data-toggle="tab"><?php echo JText::_('COM_TRANSACTION_DOCUMENTS');?></a></li>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="ip_sortableimages">
					<div class="well"><button id="addAvailable" class="btn btn-success" type="button" data-toggle="modal" data-target="#ip_avail_modal"><?php echo JText::_('COM_TRANSACTION_SELECT_AVAILABLE'); ?></button></div>
                    <div>
                        <ul id="ip_selected_images" class="thumbnails"></ul>
                    </div>
                </div>
                <div class="tab-pane" id="ip_sortabledocs">
					<div class="well"><button id="addAvailableDocs" class="btn btn-success" type="button" data-toggle="modal" data-target="#ip_availdocs_modal"><?php echo JText::_('COM_TRANSACTION_SELECT_AVAILABLE_DOCS'); ?></button></div>
                    <div>
		...
		<div id="ip_image_form" title="<?php echo JText::_('COM_IPROPERTY_MODIFY_IMAGE'); ?>" class="modal hide fade">
			<div class="modal-header">
				...
				<h3><?php echo JText::_('COM_TRANSACTION_EDIT'); ?></h3>
			</div>
			<div class="modal-body form-horizontal">
				<fieldset>
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo JText::_('COM_TRANSACTION_TITLE'); ?>
                        </div>
                        <div class="controls">
                    ...
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo JText::_('COM_TRANSACTION_DESCRIPTION'); ?>
                        </div>
                        <div class="controls">
			...
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_TRANSACTION_CLOSE'); ?></button>
				<button id="ip_image_form_save" class="btn btn-primary"><?php echo JText::_('COM_TRANSACTION_SAVE'); ?></button>
			</div>
		</div>
		...
		<div id="ip_avail_modal" class="modal hide fade" style="width: 800px; margin-left: -400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3><?php echo JText::_('COM_TRANSACTION_SELECT_AVAILABLE'); ?></h3>
				<div class="input-append">
					<input id="ip_avail_filter" type="text" class="input-small" placeholder="<?php echo JText::_('COM_TRANSACTION_KEYWORD'); ?>">
					<button class="btn" type="button"><?php echo JText::_('COM_TRANSACTION_GO'); ?></button>
				</div>
			...
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_TRANSACTION_CLOSE'); ?></button>
				<button id="ip_avail_form_save" class="btn btn-primary"><?php echo JText::_('COM_TRANSACTION_SAVE'); ?></button>
			</div>
		</div>
		<!-- DOCS HIDDEN FORMS -->
		<!-- hidden form for pop up dialog -->
		<div id="ip_docs_form" title="<?php echo JText::_('COM_IPROPERTY_MODIFY_DOCUMENT'); ?>" class="modal hide fade">
			...
			<div class="modal-body form-horizontal">
				<fieldset>
                    <div class="control-group">
                        <div class="control-label">
                            <?php echo JText::_('COM_TRANSACTION_EDIT'); ?>
                        </div>
                        <div class="controls">
			...
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_TRANSACTION_CLOSE'); ?></button>
				<button id="ip_doc_form_save" class="btn btn-primary"><?php echo JText::_('COM_TRANSACTION_SAVE'); ?></button>
			</div>
		</div>
		<!-- hidden form for available docs dialog -->
		<div id="ip_availdocs_modal" class="modal fade">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h3><?php echo JText::_('COM_TRANSACTION_SELECT_AVAILABLE_DOCS'); ?></h3>
				<div class="input-append">
					<input id="ip_availdocs_filter" type="text" class="input-small" placeholder="<?php echo JText::_('COM_TRANSACTION_KEYWORD'); ?>">
					<button class="btn" type="button"><?php echo JText::_('COM_TRANSACTION_GO'); ?></button>
				</div>
			...
			<div class="modal-footer">
				<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo JText::_('COM_TRANSACTION_CLOSE'); ?></button>
				<button id="ip_availdocs_form_save" class="btn btn-primary"><?php echo JText::_('COM_TRANSACTION_SAVE'); ?></button>
			</div>
		</div>
    <?php
	}
...
///home/raindrops/.gvfs/projects on 192.168.1.35/usmetrorealty/components/com_iproperty/assets/js/ipsortables.js
?>
