...
//echo "<pre>"; print_r($this->val); exit;
?>
...
<table class="table table-striped" id="propertyList">
            <thead>
                <tr>
                    ...
                    <th width="5%" class="nowrap">Aproved</th>
                    ...
                    <th width="5%" class="nowrap hidden-phone">Action</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td class="small hidden-phone ">
                                <?php if($item->is_approve == 1){ ?>
                                    <span class="icon-publish btn btn-micro hasTooltip" data-original-title="Activate"></span>
                                <?php } else {?>
                                    <span class="icon-unpublish btn btn-micro hasTooltip" data-original-title="Activate"></span>
                                <?php } ?>
                            </td>
                            ...
                            <?php
                                if(empty($item->transaction_id)){ ?>
                                    <td class="small hidden-phone"><a href="index.php?option=com_transaction&view=transaction&layout=email&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id?>" class="btn btn-primary">Comments</a>
                                    <a href="index.php?option=com_transaction&view=transaction&layout=mytransactionlist&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id?>" class="btn btn-primary">Details</a>
                                    <a class="btn btn-primary" href="index.php?option=com_transaction&view=addtransaction&layout=transactionedit&id=<?php echo $item->id;?>">Edit</a>
                                    </td>
                               <?php } else { ?>
                                        <td class="small hidden-phone"><a href="index.php?option=com_transaction&view=transaction&layout=email&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id;?>" class="btn btn-primary">Conversation</a>
                                        <a href="index.php?option=com_transaction&view=transaction&layout=mytransactionlist&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id?>" class="btn btn-primary">Details</a>
                                        <a class="btn btn-primary" href="index.php?option=com_transaction&view=addtransaction&layout=transactionedit&id=<?php echo $item->id;?>">Edit</a>
                                        </td>
                               <?php } ?>
