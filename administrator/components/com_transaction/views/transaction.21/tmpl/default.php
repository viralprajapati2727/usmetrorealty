                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php
                                if(empty($item->transaction_id)){ ?>
                                    <td class="small hidden-phone"><a href="index.php?option=com_transaction&view=transaction&layout=email&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id?>" class="btn btn-primary">Send Email</a></td>
                               <?php } else { ?>
                                        <td class="small hidden-phone"><a href="index.php?option=com_transaction&view=transaction&layout=email&id=<?php echo $item->id?>&agent_id=<?php echo $item->agent_id;?>" class="btn btn-primary">Conversation</a></td>
                               <?php } ?>
