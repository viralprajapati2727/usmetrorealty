     ...
     // Wordwrap for image description
      ...
      switch ($this->getConfig('image_position'))
      {
        ...
        case 3:
          ...
          $objects[$key]->imgelem = '<div class="'.$csstag.'img joomimg_img">'."\n";
          ...
          if(!empty($objecttxt))
          {
            if($this->getConfig('setjilink'))
            {
              $objects[$key]->imgelem .= '<div class="'.$csstag.'txt joomimg_txt">'."\n"
                                       .'<div class="'.$csstag.'mask joomimg_mask"></div>'."\n"
                                       .'<div class="'.$csstag.'txt_inner joomimg_txt_inner">'."\n"
                                       .'<a class="fancybox-link" title="" href="'.$obj->link.'" data-fancybox="fancybox" data-thumbnail="'.$obj->imagesource.'"><i class="fa fa-plus"></i></a>'."\n"
                                       .'<a class="joommore" title="'.$obj->imgtitle.'" href="'.$this->route('index.php?view=detail&id='.$obj->id).'"><i class="fa fa-chevron-right"></i></a>'."\n"
                                       .$objecttxt."\n"
                                       .'</div>'."\n"
                                       .'</div>'."\n";
            }
        ...
        case 4:
          ...
          if($this->getConfig('setjilink'))
          {
            $objects[$key]->imgelem .= '  <a title="'.$obj->imgtitle.'" href="'.$obj->link.'" data-fancybox="fancybox" data-thumbnail="'.$obj->imagesource.'">';
          }
