...
<div id="sp-portfolio-module-<?php echo $uniqid; ?>" class="sp-portfolio default">
	...
	<?php if($count>0) {  
		?>
		<?php require(JPATH_ROOT.'/modules/mod_ip_mapmodule/tmpl/default.php'); ?>
		<br/>
				...
				<li class="sp-portfolio-item col-<?php echo $column . ' ' . modSPPortfolioJHelper::slug($item->tag); ?> visible">
					<div class="sp-portfolio-item-inner">
						...
						<div class="sp-portfolio-item-details">
							...
							if($formattedprice2 == 'COM_IPROPERTY_CALL_FOR_PRICE'){
			                	$formattedprice2 = 'Call for price';
			                } else {
			                	$formattedprice2 = $formattedprice2;
			                }
							echo '<strong>'.JText::_( 'COM_IPROPERTY_PRICE' ).':</strong> '.$formattedprice2.' &#160;&#160;<br>';
	...
	<?php } else { 
			...
			if($user->id == 0 || empty($user->id)){
		        ...
		        $locstate = ipropertyHTML::getstatename($results->locstate);
			}
		?>
		<p class="alert">No Properties found in <?php echo $locstate;?></p>
	<?php } ?>
</div><!--/.sp-portfolio-->
