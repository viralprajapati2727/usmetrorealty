...
<div class="ip_qsmod_holder">
    <form action="<?php echo JRoute::_(ipropertyHelperRoute::getAllPropertiesRoute().'&ipquicksearch=1'); ?>" method="<?php echo $params->get('form_method', 'post'); ?>" name="ip_searchmod" class="ip_quicksearch_form">
        ...
        <div class="control-group">
            ...
            <?php if($params->get('show_price', 1) && !$params->get('price_dropdowns')): ?>
                <div class="controls">
                    <input type="text" class="input-small ip-qssearch" placeholder="<?php echo JText::_('COM_IPROPERTY_MIN_PRICE'); ?>" name="filter_price_low" value="<?php echo $post['filter_price_low']?>"/>
                </div>
                <div class="controls">
                    <input type="text" class="input-small ip-qssearch" placeholder="<?php echo JText::_('COM_IPROPERTY_MAX_PRICE'); ?>" name="filter_price_high" value="<?php echo $post['filter_price_high']?>"/>
                </div>
            <?php endif; ?>
