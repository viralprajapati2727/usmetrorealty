...
// Get module data
$items = modActiveAgentHelper::getList($params);

// echo "list-<pre>"; print_r($items); exit;
...
require(JModuleHelper::getLayoutPath('mod_activeagentlist', $params->get('layout', 'default')));