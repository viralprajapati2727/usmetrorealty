...
<div class="row-fluid<?php echo $moduleclass_sfx; ?>">
    ...
    foreach($items as $item)
    {
        ...
        ?>
        <div class="ip-genericproperties-holder span<?php echo $rowspan; ?>">
            <?php if($iplayout == 'rows') echo '<div class="span3">'; ?>
                <div class="ip-mod-thumb ip-genericproperties-thumb-holder">
                    <?php echo ipropertyHTML::getThumbnail($item->id, $item->proplink, $item->street_address, '', 'class="ip-generic-img thumbnail"', '', $usethumb); ?>
            ...
            ?>
            <div class="ip-mod-desc ip-genericproperties-desc-holder span9">
            ...
            <?php if($params->get('show_readmore', 1)): ?>
                <div class="ip-mod-readmore ip-genericproperties-readmore">
                    <a href="<?php echo $item->proplink; ;?>" class="btn btn-primary readon"><?php echo JText::_('MOD_IP_GENERIC_READ_MORE'); ?></a>
                </div>
            <?php endif; ?>
        </div>
        <?php
